 ...
 * https://namaewa.online/:roomId/:code?
...
import { HiTutorLogoWithLabel } from "../shared/components/HiTutorLogoWithLabel";
...
const NAME_LOCAL_STORAGE_KEY = "hitutor-meet-display-name";
  ...
  return (
    <div className={classes.container}>
      <div className={classes.header}>
        <HiTutorLogoWithLabel label="HiTutor Class" />
      </div>
