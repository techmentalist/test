...
export interface HiTutorAppRequest<B = {}, P = {}> {
    body: B;
    pathParams: P;
    account?: Account;
}
...
export abstract class BaseController<B = {}, P = {}> {
    ...
    protected abstract executeImpl(req: HiTutorAppRequest<B, P>, res: HiTutorAppResponse): Promise<void>;

    public async execute(req: express.Request, _res: express.Response): Promise<void> {
        const res = new HiTutorAppResponse(_res);
...
export class HiTutorAppResponse {
